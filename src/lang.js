...
const messages = {
  ...
  'en': {
    ...
    app_warn_local_storage_modal_1: "The online version of Selfless Heroes saves your game in the browser. If you delete your history or use a cleaning utility such as CCleaner, you may delete your game.",
  ...
  'fr': {
    ...
    app_warn_local_storage_modal_1: "La version en ligne de Selfless Heroes sauvegarde votre partie dans le navigateur. Si vous supprimez votre historique ou si vous utilisez un utilitaire de nettoyage comme CCleaner, vous risquez de supprimer votre partie.",
