...
const messages = {
  ...
  'en': {
    ...
    exception_invalid_direction_not_here_param_template: "%%function${keyword}()%% does not accept direction %%literal${param}%%. Use one of these instead: %%literal${allowedValues}%%",
  ...
  'fr': {
    ...
    exception_invalid_direction_not_here_param_template: "%%function${keyword}()%% n'accepte pas la direction %%literal${param}%%. Utilise celles-là à la place\u00A0: %%literal${allowedValues}%%",
