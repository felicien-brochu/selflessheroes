...
const messages = {
  ...
  'en': {
    ...
    exception_invalid_params_one_dir_or_integer_or_variable_template: "%%function${keyword}()%% requires exactly one parameter which can be a number, a variable or a direction",
    ...
    exception_invalid_dir_or_integer_or_variable_param_template: "%%variable${param}%% is not a valid number, variable or direction",
  ...
  'fr': {
    ...
    exception_invalid_params_one_dir_or_integer_or_variable_template: "%%function${keyword}()%% attend exactement un paramètre qui peut être un nombre, une variable ou une direction",
    ...
    exception_invalid_dir_or_integer_or_variable_param_template: "%%variable${param}%% n'est pas une direction, une variable ou un nombre valide",
