...
<div>
  <p v-bbcode>{{
		$text('level_help_tab_fireball_function_1')
	}}</p>

  <h5>{{$text('level_help_tab_statement_graph_code_example')}}</h5>
  <p>
    <simple-graph-code code="fireball(e)"
      :compilerConfig="defaultCompilerConfig" />

    <span v-bbcode>{{
		$text('level_help_tab_fireball_function_2')
	}}</span>
  </p>
  ...
  <p class="code"
    v-bbcode>{{$text('level_help_tab_fireball_function_3')}}</p>
</div>
</template>
