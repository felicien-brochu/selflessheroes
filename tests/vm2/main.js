...
const sandboxModule = require('./sandbox.txt');
const contextifyModule = require('./contextify.txt');
...
const CACHE = {
  ...
  timeoutContext: null,
  timeoutScript: null,
  contextifyScript: new vm.Script('(function(require, host) { ' + contextifyModule.default+'\n})', {
    filename: './contextify.txt',
    displayErrors: false
  }),
  sandboxScript: null,
  hookScript: null,
...
class NodeVM extends VM {
  ...
  constructor(options = {}) {
    ...
    if (!sandboxScript) {
      CACHE.sandboxScript = sandboxScript = new vm.Script('(function (vm, host, Contextify, Decontextify, Buffer, options) { ' + sandboxModule.default+'\n})', {
